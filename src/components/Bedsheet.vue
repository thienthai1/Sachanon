  ...
  export default {
    ...
    data() {
      return {
        slides: [
          {
            src: require('../assets/bedsheet1.jpg'),
          },
          {
          ...
          {
            src: require('../assets/S__20094979.jpg')
          }
        ],
        towels: [
        	{
        		name: 'ผ้าปูที่นอน 74*110 นิ้ว',
        		size: '250 เส้น',
