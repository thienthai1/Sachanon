      ...
      >
        ...
        >
          <v-card-title class="teal primary">
            ...
            <strong style="font-family: 'Prompt', sans-serif;font-size:14px"><img height="20px" width="20px" :src="require('./assets/call.png')" />  ติดต่อ โทร: 089-788-5439, 085-755-8581 (คุณหมู)<br>
